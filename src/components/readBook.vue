<template>
  <div>
    ...
    >
      <div v-if="pagingPattern === 0" class="books-con">
    ...
    <div
      class="page-read-option"
      :class="{ 'show-panel': option }"
      @click="setReadShow"
    >
      ...
      <div class="bottom-controll-bar">
        <div class="readSet">
          ...
          <div class="readSet-item">
            <span
              @click.stop="setPaging(0)"
              :class="{ active: pagingPattern === 0 }"
              >上下滑动</span
            >
            <span
              @click.stop="setPaging(1)"
              :class="{ active: pagingPattern === 1 }"
              >左右滑动</span
            >
          </div>
        </div>
        <van-button type="default" @click="prevChapter" style="box-shadow: none"
          >上一章</van-button
        >
        ...
        <van-button
          ...
          >目录</van-button
        >
        <van-button type="default" @click="nextChapter" style="box-shadow: none"
          >下一章</van-button
        >
      </div>
    </div>
    <div class="chapter-list" v-show="listOption" @click.stop.prevent="setList">
      ...
      <div class="source-content">
        <ul>
          ...
          >
            ...
            <div class="select" :class="{ active: _bookSource() === index }">
              已选择
            </div>
          </li>
        </ul>
